...
![image.png](images/YJoFbRG4nodMzUxooPPcssbUnJc.png)
...
![image.png](images/GqMibs7zKoL4RbxB34AcaoTznPb.png)
...
![image.png](images/STiBbeShUoOkFCxWDewcZBainKe.png)
...
![image.png](images/C7HQbdVoOoYc0QxM6VZcJm9gnob.png)
...
![image.png](images/OPB5bLl3TolnoTxXBkAc9nwmn7e.png)

## Seaborn

官网：http://seaborn.pydata.org/

![image.png](images/JqKwbUM6IoxrWQxboZ9c8Ey6nZe.png)
...
![image.png](images/WhpSbiqzhoqkFZx0pMPcDFeCn8N.png)
...
![image.png](images/S6pmbQMNqocLvzxyJACc3SNNnIg.png)
...
![image.png](images/GE2tbsSProp7JLxgpBQcEyqJnxc.png)
...
![image.png](images/NwAZbrkVIoM0AkxrRMBcZmfInbe.png)
...
![image.png](images/TesCblDz1oclLrxTCBFc8SVNnQc.png)
...
![image.png](images/EyqUb7GukoHn7IxTxPkcNfNpnkg.png)
...
![image.png](images/DepEbnclIouVZpxXgzAc7PNUnBb.png)
...
![image.png](images/RdMcbdAFFoLAOCxVABEcwyLOn7c.png)

## Pyecharts

官网：https://pyecharts.org/#/

![image.png](images/CVN2bivTloCaqtxsAmGc3sDNnye.png)
...
![image.png](images/TXvjbCmQHoNxc0xUraOc8Td7nxg.png)
...
![image.png](images/XODNb5H0DoNux3x8ITHcTRipnBc.png)
...
![image.png](images/Ni5eb5HZooZd68xd3pncF023nHh.png)
...
![image.png](images/G5VhbTOQSoYXC2xauFBcSTwInSf.png)
...
![image.png](images/MLtNbquu7oSz2ZxkQiPc5i0An5f.png)
...
![image.png](images/E1IhbnaG5oKjuRxnvgEcsvqWnlb.png)
...
![image.png](images/COi2boS0noXNIpxMKjXcdGDbnkg.png)
...
稍等几分钟，在Python的工作目录下看到一个 dist 文件，如果不知道自己的 Python 工作目录，可使用os.getcwd()命令查看。

![image.png](images/Trd0bn5Uoofo2ExozUbcb7Binlb.png)

该`dist`文件包含一个 `combine.exe` 程序，如下即为打包的程序。

![image.png](images/VqLYbPAFQoI5mQxJLNMci2CsnGf.png)
