...
![image.png](images/MmsHbcn65ocdkjx9vTfcSCZHn1d.png)

# 容器

> Docker 开启了**容器的时代**。**容器是一种比虚拟机更轻量级的技术**

![image.png](images/DhHab4TQEoPIVzxbMV6cpdQUnXb.png)
...
![image.png](images/OMKGbQft7od1I9xNqbtcZ7QDnud.png)

# Docker 入门

## Docker 架构

![image.png](images/RGRQb7mFfoA2JkxVWl4cw7q5ntb.png)
...
[📎 04、8分钟安装 Docker Desktop，让你开发效率起飞.mp4](<files/04、8分钟安装 Docker Desktop，让你开发效率起飞.mp4>)
...
![image.png](images/GksmbiWHlopLuGxfq0acWGHsnB0.png)

## 下载镜像

先去 hub.docker.com 搜索你需要的镜像（可以看镜像说明）；

![image.png](images/X0TIbSEeAoHn9hxRIkvcLn9rncc.png)
...
![image.png](images/BCQabvUS4oPoXpxpEsscC0zgnRd.png)
9. **删除**:   docker rm
...
![PixPin_2025-08-05_11-05-49.gif](images/Ok8TbwJBgoQTRpxrhvicjALunFg.gif)
...
![image.png](images/ZYZ5bYpTSoYET5xbvMrcOnNOn9b.png)
...
![PixPin_2025-08-05_11-38-43.gif](images/GzrcbqTqro5QwkxhMnoc2WYFnsf.gif)
...
![PixPin_2025-08-05_11-58-53.gif](images/BWJBb59NroCDxexm2sGcvja1nSb.gif)
...
![PixPin_2025-08-05_13-47-36.gif](images/TuzSbivP8oSLG6xDc7dc6jFfnEc.gif)
...
![image.png](images/Loowb0tzvov2OEx2HfzcxPXPntb.png)
...
![image.png](images/CO8ZbyauToB1GBxT6oWcAPwPnDb.png)
...
![image.png](images/Br6MbebigoGFGnxK7S2cUUGBn0c.png)
...
![image.png](images/MXjmbIyqmoI51txaiF6cNZjunPe.png)
...
![image.png](images/Te8ebL9gDoU8vDx8aUHccVZGnUc.png)

### 公共层

![image.png](images/J6Xibz68oosoGqxOC5WciPa2nyd.png)

### 镜像层与容器层

![image.png](images/IDbmbtzwfoHYLFxVRKacE9gfnVd.png)

### 多容器与镜像

![image.png](images/G1MebrvfwomHfTxhMPbcftOYnLh.png)

# 总结

![image.png](images/XjF5bdfyRo2P7NxcmCzcgjWfnOh.png)