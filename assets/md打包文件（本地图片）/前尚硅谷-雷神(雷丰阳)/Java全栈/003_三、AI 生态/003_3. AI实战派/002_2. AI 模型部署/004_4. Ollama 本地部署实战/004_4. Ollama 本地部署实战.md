...
![image.png](images/SIQPbl3hHoiDBtxyxdhcYBsGnhd.png)
...
![image.png](images/E9l9bFmh4oBUK5x3IClcQDspnGb.png)

下载完成后可以直接在命令行运行：

![image.png](images/Sm78bfPIVo7ChhxiFuoco6rCnsE.png)
...
![image.png](images/Wfkqb1LU1o2j1DxKqQZc7kjZnpc.png)

下载后打开客户端，模型提供方选择 `Ollama API`，API 域名就是我们上面提到了本地 11434 端口的服务，另外它可以自动识别你的电脑上已经通过 `Ollama` 安装的模型：

![image.png](images/X15kbl4clo0uBtx1NVqckONEnXc.png)

然后就可以在聊天窗选择到你的本地模型了：

![image.png](images/SLwIbihLgoWCyxxaQsXcSDhWnCi.png)
...
![image.png](images/XnGBbA8i3oClt6xI54QcgxEgnPb.png)
