...
![94345243-89c2-4f12-958d-a9919b9ba074.jpeg](images/AtpybSbV5oAr2jxSHhBcisvzngf.jpeg)
...
2. 第二步：中间操作
  1. 对数据源的数据进行处理，该操作会返回一个Stream对象，因此可以进行**链式操作**。
3. 第三步：终止操作
  1. **执行终止操作时，则才会真正执行中间操作**，并且返回一个计算完毕后的结果。
...
![94345243-89c2-4f12-958d-a9919b9ba074.jpeg](images/RRMrbGGyWoDrQXxbpW7cKGbGnNh.jpeg)
...
![94345243-89c2-4f12-958d-a9919b9ba074.jpeg](images/LOKMb6mFxou4GmxIBmRcPufLngh.jpeg)
...
// 需求：筛选出字符串长度大于3的元素
Stream<String> stream2 = Stream.of("hello", "too", "like", "jack");
...
```java
// 需求：把字符串中的字母全部转化为大写
Stream<String> stream1 = Stream.of("hello", "too", "like", "jack");
...
```java
// 需求：将三个集合中的元素映射到同一个流中
Stream<List<Integer>> stream4 = Stream.of(Arrays.asList(1, 2, 3), Arrays.asList(4, 5, 6), Arrays.asList(7, 8, 9));
stream4.flatMap(list -> list.stream()).forEach(System.out :: println);
```

![94345243-89c2-4f12-958d-a9919b9ba074.jpeg](images/LngTbi9LgojlWaxlAoScNB4InLg.jpeg)
...
![94345243-89c2-4f12-958d-a9919b9ba074.jpeg](images/PUc3bp7wqozJ5jxZyUGc4HB4nSf.jpeg)
...
// 需求：获得第一个学生
Optional<Student> first = StudentData.getStudentList().stream().findFirst();
// 直接取（有报异常的风险）
Student stu = first.get();
System.out.println(stu);
// 安全的取出
if(first.isPresent()){ // 判断有没有，true表示有。
...
StudentData.getStudentList().stream().skip(3).findFirst().ifPresent(System.out::println);
```
...
![94345243-89c2-4f12-958d-a9919b9ba074.jpeg](images/UI0ibz2APonIAQxSe14cHnZ9nwe.jpeg)
...
![94345243-89c2-4f12-958d-a9919b9ba074.jpeg](images/Cboybd8R7oGU0ax0lVwcXWSqnLh.jpeg)
